...
<form action="{{ route('log.insert', ['kd_it' => $asset->kd_it]) }}" method="post">
@csrf
@method('POST')
<div class="row">
    <div class="col-6">
    ...
    <div class="col-6">
        ...
        <div class="form-group">
            ...
            <input type="text" required="required" name="dept" class="form-control" />
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" required="required" name="kondisi" class="form-control"  />
        </div>
        <div class="form-group">
